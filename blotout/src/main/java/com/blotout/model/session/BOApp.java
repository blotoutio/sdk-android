...
public class BOApp {
    ...
    public static BOApp fromJsonString(String json) throws IOException {
        return getObjectReader().readValue(json);
    }

    @Nullable
    public static BOApp fromJsonDictionary(HashMap<String,Object> jsonDict)  {
     try {
    ...
    public static String toJsonString(BOApp obj) throws JsonProcessingException {
    ...
    private static void instantiateMapper() {
        ...
        reader = mapper.reader(BOApp.class);
        writer = mapper.writerFor(BOApp.class);
    }
