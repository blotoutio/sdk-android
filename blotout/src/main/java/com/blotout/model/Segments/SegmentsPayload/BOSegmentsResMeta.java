...
public class BOSegmentsResMeta {
    private static final String TAG = "BOSegmentsResMeta";
    ...
    public static BOSegmentsResMeta fromJsonString(String json) throws IOException {
        return getObjectReader().readValue(json);
    }

    @Nullable
    public static BOSegmentsResMeta fromJsonDictionary(HashMap<String,Object> jsonDict) {
        try {
    ...
    public static String toJsonString(BOSegmentsResMeta obj) throws JsonProcessingException {
    ...
    private static void instantiateMapper() {
        ...
        reader = mapper.reader(BOSegmentsResMeta.class);
        writer = mapper.writerFor(BOSegmentsResMeta.class);
    }
