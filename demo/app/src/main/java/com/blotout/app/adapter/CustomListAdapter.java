...
public class CustomListAdapter extends RecyclerView.Adapter<CustomListAdapter.CustomViewHolder> {
    ...
    private void handleLocationInfo(@NonNull CustomViewHolder holder, int position) {
        switch (position) {
    ...
    private void handleAppInfo(@NonNull CustomViewHolder holder, int position) {
        switch (position) {
    ...
    private void handleBatteryInfo(@NonNull CustomViewHolder holder, int position) {
        switch (position) {
    ...
    private void handleMemoryInfo(@NonNull CustomViewHolder holder, int position) {
        switch (position) {
    ...
    private void handleNetworkInfo(@NonNull CustomViewHolder holder, int position) {
        switch (position) {
    ...
    private void handleDeviceInfo(@NonNull CustomViewHolder holder, int position) {
        switch (position) {
