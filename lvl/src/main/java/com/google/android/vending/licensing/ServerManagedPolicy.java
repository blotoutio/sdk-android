...
public class ServerManagedPolicy implements Policy {
     ...
     */
    public ServerManagedPolicy(@NonNull Context context, Obfuscator obfuscator) {
        // Import old values
     ...
     */
    private void setValidityTimestamp(@NonNull String validityTimestamp) {
     ...
     */
    private void setRetryUntil(@NonNull String retryUntil) {
        Long lRetryUntil;
        try {
     ...
     */
    private void setMaxRetries(@NonNull String maxRetries) {
        Long lMaxRetries;
        try {
