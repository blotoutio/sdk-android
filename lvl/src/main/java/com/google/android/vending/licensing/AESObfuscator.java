...
public class AESObfuscator implements Obfuscator {
    ...
    @Nullable
    public String obfuscate(@Nullable String original, String key) {
        if (original == null) {
            return null;
        }
        try {
    ...
    @Nullable
    public String unobfuscate(@Nullable String obfuscated, @NonNull String key) throws ValidationException {
        if (obfuscated == null) {
            return null;
        }
        try {
