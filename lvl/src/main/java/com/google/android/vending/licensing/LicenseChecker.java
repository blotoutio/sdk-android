...
public class LicenseChecker implements ServiceConnection {
     ...
     */
    public LicenseChecker(@NonNull Context context, Policy policy, @NonNull String encodedPublicKey) {
        mContext = context;
        mPolicy = policy;
     ...
     * @throws IllegalArgumentException if encodedPublicKey is invalid
     */
    private static PublicKey generatePublicKey(@NonNull String encodedPublicKey) {
        try {
     ...
     * @param callback
     */
    public synchronized void checkAccess(@NonNull LicenseCheckerCallback callback) {
     ...
     */
    public void followLastLicensingUrl(@NonNull Context context) {
    ...
    private class ResultListener extends ILicenseResultListener.Stub {
        ...
        public void verifyLicense(final int responseCode, @NonNull final String signedData,
     ...
     * timeouts.
     */
    private synchronized void handleServiceConnectionError(@NonNull LicenseValidator validator) {
     ...
     */
    @NonNull
    private static String getVersionCode(@NonNull Context context, @NonNull String packageName) {
        try {
